...
public class Localization
{
    ...
    public static List<Locale> getAvailableLocales()
    {
        ...
        {
            Model.logThrowable("failed loading available locales", e); //$NON-NLS-1$
        }
        finally 
        {
            try 
    ...
    public static void main(String[] args)
    {
        ...
        for (Locale locale : locales)
        {
            ...
            Set<? extends String> bundleKeys = (Set<? extends String>) bundle.keySet();
            
            List<String> defaultKeys = new ArrayList<>((Collection<? extends String>) defaultBundle.keySet());
