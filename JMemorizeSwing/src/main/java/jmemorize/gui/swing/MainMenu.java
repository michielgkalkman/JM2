...
public class MainMenu extends JMenuBar implements RecentItemsObserver
{
    ...
    public MainMenu(SelectionProvider selectionProvider, RecentItems recentFiles, JMemorizeIO jMemorizeIO, JMemorizeUI jMemorizeUI) {
    ...
    private void buildFileMenu()
    {
        ...
        m_fileMenu.add(new OpenLessonAction(jMemorizeIO, jMemorizeUI));
        m_fileMenu.add(new SaveLessonAction(jMemorizeIO));
        m_fileMenu.add(new SaveLessonAsAction( jMemorizeIO));
        ...
        importMenu.add(new ImportJMLAction( jMemorizeIO));
        ...
        {
            JMenuItem menuItem = new JMenuItem(new OpenRecentLessonAction(i, jMemorizeIO));
